INSERT INTO estados (nome, sigla, regiao, populacao)
    -- "INSERT INTO <tabela> (<colunas em ordem>)" define a tabela para adicionar os dados
    VALUES ('Acre', 'AC', 'Norte', 0.83);
        -- "VALUES (<valores das colunas em ordem>)" Define as linhas de dados para adicionar na tabela
